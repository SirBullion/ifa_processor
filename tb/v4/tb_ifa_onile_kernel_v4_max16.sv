...
module tb_ifa_onile_kernel_v4_max16;
    ...
    localparam integer YARA_W     = $clog2(MAX_YARA);
    ...
    initial begin
        $dumpfile(
            "sim/v4/ifa_onile_kernel_v4_max16.vcd"
        );

        $dumpvars(
            0,
            tb_ifa_onile_kernel_v4_max16
        );
        ...
        $display(
            "IFÁ V4 ONÍLẸ̀ KERNEL MAX_YARA=16 TEST"
        );
        $display(
            "============================================================"
        );
        ...
        //--------------------------------------------------------------
        // MAX16 native mathematics: YÀRÁ 3 — DÁGBA
        //
        // 0x21 * 0x42 = 0x0882
        //--------------------------------------------------------------
        ...
        $display(
            "PASS: ONILE KERNEL MAX_YARA=16 VERIFICATION COMPLETE"
        );
